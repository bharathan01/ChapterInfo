...
const Careers: React.FC = () => {
  const jobOpenings = [
    {
      ...
      description: "We're looking for a Senior Full Stack Developer to build innovative solutions for our clients.",
      requirements: [
    ...
    },
    {
      ...
      type: "Full-time",
      department: "Security",
      description: "Join our security team to help protect our clients from evolving cyber threats.",
      requirements: [
    ...
    },
    {
      ...
      type: "Full-time",
      department: "Design",
      description: "Create exceptional user experiences for our products and client solutions.",
      requirements: [
    ...
    },
    {
      ...
      type: "Full-time",
      department: "Product",
      description: "Lead the development and growth of our innovative product offerings.",
      requirements: [
    ...
    },
    {
      ...
      type: "Full-time",
      department: "Engineering",
      description: "Develop and implement AI and machine learning solutions for our products.",
      requirements: [
  ...
  const benefits = [
    ...
    {
      title: "Flexible Work",
      description: "Remote-friendly options and flexible scheduling to support work-life balance.",
      icon: <Laptop size={24} />
    },
    {
      title: "Professional Development",
      description: "Learning stipend, conference attendance, and career growth opportunities.",
      icon: <GraduationCap size={24} />
    },
    {
      title: "Inclusive Culture",
      description: "Diverse, equitable, and inclusive environment where everyone can thrive.",
      icon: <Users size={24} />
    }
  ];
    ...
    <Layout>
      ...
      <section className="pt-32 pb-20 bg-gradient-to-b from-black to-gray-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              Build the future of technology with us and grow your career in a collaborative and innovative environment
            </motion.p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <SectionTitle 
                title="Our Culture" 
                subtitle="Life at TechBloom"
                light
              />
              
              <p className="text-gray-300 mb-6">
                At TechBloom, we foster a culture of innovation, collaboration, and continuous learning. We believe that the best ideas come from diverse perspectives and that everyone has something valuable to contribute.
              </p>
              
              <p className="text-gray-300 mb-8">
                Our team is passionate about technology and committed to delivering exceptional solutions for our clients. We work in an environment that encourages creativity, rewards initiative, and supports professional growth.
              </p>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                {["Innovation", "Collaboration", "Excellence", "Integrity", "Diversity", "Growth"].map((value, index) => (
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-400 mb-4">
              We also offer competitive salaries, equity options, 401(k) matching, paid time off, parental leave, and more.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="openings" className="py-20 bg-black">
        <div className="container mx-auto px-4">
          ...
          >
            <h3 className="text-2xl font-orbitron font-bold text-white mb-4">Don't See the Right Fit?</h3>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.p
              ...
              className="text-xl text-gray-300 mb-8"
            >
              Join our team and be part of building innovative technology solutions that transform businesses worldwide.
            </motion.p>
